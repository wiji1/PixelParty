...
public class TitleManager {
	...
	public static void displayEndTitle() {
		...
		if(alivePlayers.size() == 1) {
			title = MetaDataUtil.getDisplayName(alivePlayers.get(0));
			subtitle = "&7is the winner of this game!";
		} else if(alivePlayers.size() == 2) {
			title = MetaDataUtil.getDisplayName(alivePlayers.get(0)) + " &f& " +
					MetaDataUtil.getDisplayName(alivePlayers.get(1));
